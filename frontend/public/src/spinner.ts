...
export function initSpinner() {
  ...
  spinner.innerHTML = /*html*/`
        <div
          class="text-teal-500 bg-black/20 inline-block h-16 w-16 animate-spin rounded-full border-8 border-solid border-current border-e-transparent align-[-0.125em] text-surface motion-reduce:animate-[spin_1.5s_linear_infinite]"
          role="status">
        </div>
